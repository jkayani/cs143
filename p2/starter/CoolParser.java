...
// Fri Dec 25 19:36:26 UTC 2020
//----------------------------------------------------

import java_cup.runtime.*;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Dec 25 19:36:26 UTC 2020
  */
public class CoolParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\037\000\004\004\007\001\002\000\006\002\001\004" +
    "\007\001\002\000\004\002\040\001\002\000\006\002\uffff" +
    ...
    "\000\006\051\ufff8\056\ufff8\001\002\000\004\053\031\001" +
    "\002\000\004\043\ufff6\001\002\000\004\043\034\001\002" +
    "\000\004\032\032\001\002\000\004\053\033\001\002\000" +
    "\004\043\ufff5\001\002\000\006\051\ufff7\056\ufff7\001\002" +
    "\000\006\051\036\056\015\001\002\000\004\043\037\001" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\037\000\010\002\004\003\003\004\005\001\001\000" +
    "\004\004\040\001\001\000\002\001\001\000\002\001\001" +
    ...
    "\001\000\002\001\001\000\006\007\027\010\026\001\001" +
  ...
  public final java_cup.runtime.Symbol CUP$CoolParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CoolParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // addition ::= INT_CONST PLUS INT_CONST 
            {
              plus RESULT =null;
		AbstractSymbol i1 = (AbstractSymbol)((java_cup.runtime.Symbol) CUP$CoolParser$stack.elementAt(CUP$CoolParser$top-2)).value;
		AbstractSymbol i2 = (AbstractSymbol)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
		
		RESULT = new plus(curr_lineno(), new int_const(curr_lineno(), i1), new int_const(curr_lineno(), i2));
	
              CUP$CoolParser$result = parser.getSymbolFactory().newSymbol("addition",6, RESULT);
            }
          return CUP$CoolParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // expr ::= addition 
            {
              Expression RESULT =null;
		plus a = (plus)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
